...
export { default as ShapesIcon } from './shapes-icon.svelte';
export { default as PolygonIcon } from './polygon-icon.svelte';
...
export { default as EllipseIcon } from './ellipse-icon.svelte';
